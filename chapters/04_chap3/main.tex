...
These anomalies, which occur in the absence of on-site measured seismic waves, suggest that stress-induced modulation of mixing between chemically distinct groundwater components is occurring.
...
Earthquakes rank among the most devastating natural disasters, causing an average of over $27.6$ billion USD in global economic losses each year since 2000, and resulting in approximately 100,000 deaths annually \citep{bilham2004urban, emdat2024damage}.
...
In addition to hydrological shifts, certain geochemical changes in groundwater have been linked to seismic activity.
Anomalous concentrations of dissolved gases such as Rn, He, \ce{H2}, and \ce{CO2} have been observed before and after earthquakes \citep{segovia1989radon, igarashi1995radon, toutain1999seismo, gunatilake2023japan, sano2016kumamoto}.
Increased emissions of \ce{CO2} along fault zones have been reported following major earthquakes in regions such as along the Apennine chain in Italy, pointing to a connection between high seismicity and geochemical fluxes \citep{chiodini2020co2, curzi2024fossil}.
...
These structural changes in pore geometry are well documented in both pre- and post-seismic periods of large earthquakes, where shifts in subsurface flow dynamics have been shown to alter groundwater geochemistry and water levels \citep{won2019response, rutter2016aquifer}.
...
Here, we apply these methods to investigate how seismic activity influences the dissolved gas composition of groundwater in a hydrothermal field.
...
The initial evidence of a systematic relationship between seismicity and groundwater composition emerged from two larger earthquakes: the Arolla (main shock on 2021-10-05 07:39, M$_w$ = 4.1) and Sanetsch (main shock on 2021-11-01 21:13, M$_w$ = 2.8) events, which occurred within \SI{50}{\kilo\meter} of Lavey-les-Bains in late 2021.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.94\textwidth]{chapters/04_chap3/figures/arolla_sanetsch.pdf}
...
The Euclidean Distance (EuD) for \ce{CO2}/Ar vs. \ce{CH4}/Ar analysis (subsection \ref{methods:EuD} for details) revealed a pronounced increase in EuD values in the days preceding both earthquakes (Figure~\ref{fig:EuD_SanAr}).
EuD quantifies the distance between the centroids of two successive time windows in compositional space, providing a measure of temporal shifts in groundwater chemistry.
In this case, elevated EuD values indicate measurable changes linked to seismic activity, independent of direct ground shaking effects \citep{giroud2023new}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.94\textwidth]{chapters/04_chap3/figures/article_EuD_SanAr.pdf}
    \caption{EuD values for \ce{CO2}/Ar vs. \ce{CH4}/Ar ratios in well P201 during the Arolla and Sanetsch earthquakes (dashed vertical lines).
    EuD were computed at a \SI{1}{\day}-resolution using time intervals ranging from \SIrange{1}{15}{\day}.
    }
    \label{fig:EuD_SanAr}
\end{figure}

In both cases, the compositional shift reflects a subtle increase in \ce{CO2}/Ar and a concurrent decrease in \ce{CH4}/Ar (Figure \ref{figSI:ratios_SanAr}).
Given the known source characteristics of these gases---\ce{CH4} being enriched in the deep, geochemically evolved groundwater component, and \ce{CO2} associated with a shallower, surface-near component \citep{giroud2025microbio}---this pattern suggests a temporary reduction in the contribution of deep groundwater to the overall mix.
We also note that these geochemical changes consistently precede both respective seismic events.
...
EuD for \ce{CO2}/Ar vs. \ce{CH4}/Ar was calculated using a 7-day moving window at a 1-day resolution.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{chapters/04_chap3/figures/full_EuD_7_article.pdf}
    \caption{
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{chapters/04_chap3/figures/distribution_earthquakes_wo_outliers_well_201.pdf}
...
Notably, the duration of these geochemical changes (spanning several days) far exceeds that of the seismic events themselves.
Moreover, these signals occur in the absence of detectable seismic waves at Lavey-les-Bains.
Together, these observations suggest that the geochemical changes are driven by stress accumulation rather than coseismic rupture.
...
We interpret these observations as the geochemical expression of stress-induced modulation of groundwater flow.
The Lavey-les-Bains hydrothermal system is characterized by the mixing of chemically distinct water components, as shown by hydrogeological models and tracer studies \citep{sonney2009numerical, giroud2025microbio}.
A deep, geochemically evolved component interacts and mixes with younger, less mineralized groundwater between approximately \SIrange{200}{500}{\metre} depth.
If tectonic stress alters fracture connectivity or permeability, even slightly, it could shift the relative contribution of these water components to the overall groundwater mixture, particularly affecting the concentrations of trace gases like \ce{CO2} and \ce{CH4}, which are strongly source-dependent.

This interpretation is supported by the directional change of the observed short-term gas ratio shifts (Figure~\ref{figSI:ratios_SanAr})---consistent with a reduced contribution from the deep, \ce{CH4}-rich component and increased input from the shallower, \ce{CO2}-bearing component \citep{giroud2025microbio}.
In the geothermal system of Lavey-les-Bains, the shallow component is recharged by infiltration from the nearby Rhône River, maintaining relatively high hydraulic pressure.
...
The absence of a comparable signal in well P600, which predominantly captures the deeper, more geochemically stable endmember, can also be explained by the framework of local surface water mixing into the thermal system.
...
The absence of direct rupture or seismic waves measured at Lavey-les-Bains highlights the role of regional elastic strain fields as drivers of subsurface hydrodynamics.
...
High-frequency geochemical monitoring---particularly in settings where distinct water components interact and mixes---may reveal similar stress-induced signals, offering a new lens on crustal deformation and its hydrological consequences.

% Conclusion
\section{Conclusion}
This study demonstrates that regional seismicity can transiently alter groundwater geochemistry by modulating subsurface mixing dynamics between chemically distinct groundwater components.
The observed geochemical fluctuations---occurring without local rupture and often preceding the seismic events---identify elastic strain as a powerful control on crustal hydrology.
These results offer a new perspective on how tectonic stress can influence fluid pathways in geothermal systems.
...
This geothermal system facilitates mixing between ancient, hot groundwater and cooler, less evolved groundwaters at depths of \SIrange{200}{500}{\meter}, with reservoir temperatures estimated at \SIrange{110}{120}{\celsius} \citep{sonney2009numerical, wanner2019quantification, giroud2025microbio}.
...
Within each interval, gas concentration measurements were averaged to obtain two mean values, the centroids \(M_1\) and \(M_2\), representing the mean gas composition for each period.
EuD was then computed as the Euclidean distance between these centroids in compositional space, according to equation \ref{form:1}:

\begin{equation}
    \label{form:1}
    \text{EuD}(t_0) = \sqrt{ \sum_{i=1}^{2} \left( \overline{R_i}_1 - \overline{R_i}_2 \right)^2 }
\end{equation}

Here, \(R_1 = \ce{CO2}/\ce{Ar}\) and \(R_2 = \ce{CH4}/\ce{Ar}\) are the gas ratios of interest, and \(\overline{R_i}_1\) and \(\overline{R_i}_2\) denote their respective averages in the first and second time intervals.
...
By applying this analysis to the normalized gas ratios \ce{CO2}/Ar and \ce{CH4}/Ar, we enhanced sensitivity to changes in fluid mixing within the geothermal system.
The selection of these gases was based on their low concentrations (approximately \SI{1}{\percent} of the total gas) and their known sensitivity to subsurface processes.
...
Observed and synthetic distributions were compared using a two-sample Kolmogorov–Smirnov (KS) test (\texttt{ks\_2samp}, SciPy), with a significance threshold of \SI{5}{\percent}.
...
See Appendix \ref{ch:appendix_ch3}.