...
In well P201, repeated shifts in dissolved gas composition---quantified by changes in \ce{CO2}/Ar and \ce{CH4}/Ar ratios---align with increased regional seismicity.
...
If tectonic stress alters fracture connectivity or permeability, even slightly, it could shift the relative contribution of these reservoirs to the overall groundwater mixture, particularly affecting the concentrations of trace gases like \ce{CO2} and \ce{CH4}, which are strongly source-dependent.

This interpretation is supported by the directionality of the observed gas ratio shifts (Figure~\ref{figSI:ratios_SanAr})---consistent with a reduced contribution from the deep, \ce{CH4}-rich component and increased input from the shallower, \ce{CO2}-bearing reservoir \citep{giroud2025microbio}.
