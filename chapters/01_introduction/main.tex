...
The Earth's interior contains vast amounts of thermal energy, primarily originating residual heat from planetary formation, natural radioactivity, magmatic activity, and other physical reactions \citep{leyton2017earth, lay2008heat}.
...
This process forms geothermal systems that encompass the entire groundwater circulation network, from recharge zones to deep subsurface reservoirs and outflows.
The outflow of the system can manifest at the surface as hot springs, geysers, or fumaroles \citep{barbier2002geotherms}.
...
However, these systems are not only highly dynamic, with fluid pathways and geochemical conditions constantly evolving in response to seismic activity and seasonal hydrological changes, but also logistically difficult to access.
Most deep geothermal environments are only reachable through costly drilling operations, which limits opportunities for long-term monitoring.
These scientific and logistical constraints make geothermal systems particularly challenging to study.
...
Periodic groundwater recharge modifies temperature, pressure, and fluid chemistry within deep crustal systems, potentially influencing the structure and function of microbial communities adapted to specific extreme geothermal conditions.
...
While the deep biosphere in geothermal environments is known to host diverse and metabolically active microorganisms that contribute to geochemical cycling, their response to environmental disturbances has yet to be fully characterized \citep{colman2017review}.
In parallel, seismic events have been shown to induce significant changes in fluid circulation and geochemical composition, likely as a result of tectonic movement in the subsurface \citep{toutain1999seismo, ide2020kumamoto, igarashi1995radon, sano2016kumamoto}.
The extent to which seismic activity perturbs fluid dynamics within deep geothermal fields remains unresolved, posing challenges for understanding subsurface processes and evaluating their potential implications for earthquake-related fluid migration and according geochemical changes.
...
This thesis focuses on three core research objectives:

\begin{itemize}
    \item Is seasonal mixing driving deep crustal microbial communities within a geothermal field?
    \item What is the relationship between deep continental geothermal fluids and seismicity?
\end{itemize}

\section{Methodological Challenges in Deep Geothermal Monitoring}
Investigating the above questions requires robust analytical techniques capable of capturing the dynamic processes governing microbial communities and fluid circulation in geothermal fields.
...
The miniRUEDI system, a portable gas mass spectrometer, enables real-time analysis of noble gases and reactive species (e.g., \ce{O2}, \ce{CH4}, and \ce{CO2}), providing a significant advantage over traditional copper tube sampling \citep{brennwald2016portable}.
The miniRUEDI comes at the expense of a reduction in analytical precision, particularly for the determination of isotopic ratios.
However, this trade-off is considered acceptable, as the geochemical changes of interest in geothermal systems typically occur at the gas species level rather than at the isotopic level.
Applying this method in high-temperature geothermal environments remains challenging: the gas-permeable membrane is susceptible to condensation and clogging in thermal waters due to temperature differences between the sampled water and the ambient environment.
...
Deep boreholes are exploited by a local thermal spa facility to extract thermal water, offering rare access to subsurface fluids and enabling long-term monitoring at various depths.
...
Following this introductory chapter, Chapter \ref{ch:methodological} presents the development of a new methodology for long-term gas monitoring in thermal waters, which provides the basis to rigorously assess geochemically the evolution of a thermal system in time.
Chapters \ref{ch:microbiology} and \ref{ch:seismicity} apply this methodology to two distinct questions: Chapter \ref{ch:microbiology} investigates the resilience of microbial communities to seasonal hydrological variations, while Chapter \ref{ch:seismicity} explores the relationship between fluid geochemistry and seismicity.
Finally, Chapter \ref{ch:summary} synthesizes the results and discusses broader implications, including potential applications of the developed techniques in geothermal research and environmental monitoring.\vspace{10pt}
...
The main experimental challenge addressed is the formation of macroscopic water in the analyzed gas phase when its temperature exceeds the ambient temperature, leading to condensation-induced clogging of the miniRUEDI inlet.
...
More than \num{250000} gas measurements from two deep wells abstracting thermal water at \SI{200}{\metre} (P201) and at \SI{516}{\metre} (P600) in Lavey-les-Bains were analyzed using a Euclidean distance approach to analyze changing gas compositions.
The Euclidean distance allows the identification of short-term (several days) geochemical variations against long-term (seasonal) and very short-term (pumping-related) effects.
