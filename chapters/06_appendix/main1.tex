...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{chapters/06_appendix/SI_C2/correlation_plot.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{chapters/06_appendix/SI_C2/Ne20-He3-He4.pdf}
\caption{
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{chapters/06_appendix/SI_C2/CD-plot.pdf}
\caption{
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{chapters/06_appendix/SI_C2/PCoA_arc_wuni_all_OTUs.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{chapters/06_appendix/SI_C2/PCoA_bac_wuni_all_OTUs.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{chapters/06_appendix/SI_C2/LLB_NewBathyarchaeotaGroup.pdf}
\caption{
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{chapters/06_appendix/SI_C2/phylum_test_Lavey.pdf}
\caption{
...
Adapted from \cite{giroud2025microbio}; continued in Part 2 on the next page.}
...
The NTCs indicate the relative abundance of the reads compared to the samples and help to assess potential contamination by the respective taxa.
The results show that the most abundant taxa are predominantly from the samples and not from contamination.
Adapted from \cite{giroud2025microbio}.}
