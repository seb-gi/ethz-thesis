...
The continental subsurface plays a fundamental role in global environmental processes, including carbon sequestration, long-term nuclear waste storage, and geothermal energy exploitation.
...
This thesis sought to address some of these challenges by investigating fluid-seismic interactions and deep microbial ecosystems in the Lavey-les-Bains geothermal system in Switzerland.
...
The results of this study have provided insights into microbial stability at depth, the dominance of temperature in shaping microbial ecosystems, and the potential of geochemical signals in deep thermal waters as indicators of subsurface stress during increased seismic activity.
...
A significant challenge in geothermal gas monitoring arises when water temperatures exceed ambient conditions, causing water vapor to condense within the gas headspace.
This phenomenon results in clogging and interruptions in monitoring processes.
...
Although the observed effects were only observed in one site, this study provides one of the first long-term records of geochemical responses to seismicity in a deep continental geothermal system.
...
Similar research in Iceland, the Apennines (Italy), the San Andreas Fault (USA), New Zealand, and Japan could test the reproducibility of these findings and refine geochemical monitoring to assess groundwater geochemistry in response to seismicity.
...
Beyond investigating the relationship between groundwater geochemistry and seismicity, this research has also advanced helium-based geothermal prospecting (Figure~\ref{fig:concl_valais}), demonstrating that elevated \ce{^4He} concentrations can serve as tracers for deep geothermal reservoirs.
A pilot study was conducted in the Canton of Valais to quantify \ce{^4He} concentrations in groundwater from multiple piezometers using the miniRUEDI.
The results revealed localized enrichment of non-atmospheric, terrigenic helium.
These anomalies suggest hydraulic connectivity between the shallow alluvial aquifer of the Rhône Valley and deeper groundwater sources, possibly of geothermal origin, as observed in Lavey-les-Bains.
Such excess \ce{^4He} is indicative of deep fluid inputs, as crustal helium accumulates over time in long-residence groundwater.
However, further research is needed to refine the spatial resolution of this approach, evaluate the extent of helium diffusion into shallower water tables, and assess the potential for detecting helium in unsaturated zone gas emissions.
Future work should focus on multi-scale helium tracing and integration with geophysical methods to better constrain subsurface fluid migration pathways and geothermal reservoir connectivity.

\FloatBarrier  

\begin{figure}[h]  % Allow some flexibility in placement
\begin{center}
...
These efforts will support more sustainable geothermal resource management, improved seismic risk assessment, and new insights into microbial life in extreme environments and fluid evolution in the deep crust.