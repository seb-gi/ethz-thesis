\begin{table*}[ht]
\caption{Results of the main geochemical parameters and microbiological quantification in the three main deep wells of Lavey-les-Bains and the surface well AP.
Adapted from \cite{giroud2025microbio}.}
\label{table:geochemistry}
\centering
{\footnotesize  % Use footnotesize instead of small
\renewcommand{\arraystretch}{1.2}  % Reduced row height
\resizebox{\textwidth}{!}{%
\begin{tabular}{lc|ccc|c|ccc}
\toprule
