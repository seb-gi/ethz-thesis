\usepackage[
  style=authoryear,%
  %style=science, style=nature, article-title=true,%
  natbib=true,%
  clearlang=true,%
  backend=biber,%
  maxnames=2,         % Show up to 2 authors before using "et al."
  minnames=1,         % Use "et al." when more than 2 authors
  uniquelist=false,   % Avoid adding extra author names when unnecessary
]{biblatex}


\setlength\bibitemsep{0.5em}  % Adjust to increase spacing
...
\ExecuteBibliographyOptions{%
  ...
  autopunct=true,
  language=auto,
  autolang=other, % (none, hyphen, other, other*)
